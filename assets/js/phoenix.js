    ...
    const tooltipFormatter = (params, dateFormatter = 'MMM DD') => {
      ...
      params.forEach(el => {
        tooltipItem += `<div class='ms-1'>
          <h6 class="text-700"><span class="fas fa-circle me-1 fs--2" style="color:${el.color
          }"></span>
            ...
            if (isSearching) {
              ...
              listInfo &&
                (listInfo.innerHTML = `${list.matchingItems.length === 0 ? 0 : list.i
                  ...
                  } <span class='text-600'> Items of </span>${list.matchingItems.length
                  }`);
            }
...
$(document).on('click', '.altera-logo-tema', function () {
  ...
  if (window.config.config.phoenixTheme === "dark") {
    // logo tema escuro (branca no fundo escuro)
    ...
    // logo tema claro (preta no fundo claro)
