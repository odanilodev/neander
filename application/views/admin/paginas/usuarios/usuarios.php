                                ...
                                <td class="align-middle white-space-nowrap text-center pe-0">
                                    <div class="font-sans-serif btn-reveal-trigger position-static">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end py-2">
                                            <a href="<?= base_url('usuarios/formulario/' . $v['id']) ?>" class="dropdown-item editar-usuario">
                                                <span class="fas fa-pencil ms-1"></span> Editar
                                            </a>
                                            <a href="<?= base_url('usuarios/permissaoUsuarios/' . $v['id']) ?>" class="dropdown-item permissao-usuario">
                                                <span class="fas fa-lock ms-1"></span> Permissões
                                            </a>
                                            <a href="#" class="dropdown-item deletar-usuario" onclick="deletarUsuario(<?= $v['id'] ?>)">
