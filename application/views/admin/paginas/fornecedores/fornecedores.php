    ...
    <div class="row align-items-center justify-content-between g-3 mb-4">
      <div class="col-auto">
        <div class="d-flex align-items-center">
          ...
          <a href="<?= base_url("fornecedores/formulario/") ?>" class="btn btn-phoenix-primary">
            <span class="fas fa-plus me-2"></span>Cadastrar Fornecedor
          </a>
        </div>
      </div>
      <div class="col col-auto">
        <div class="search-box">
          <form class="position-relative" data-bs-toggle="search" data-bs-display="static">
            <input class="form-control search-input search" type="search" placeholder="Buscar Fornecedores" aria-label="Search" />
          ...
          <tbody class="list" id="members-table-body">
            <?php foreach ($fornecedores as $fornecedor) { ?>
              <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                ...
                <td class="td_cnpj align-middle white-space-nowrap">
                  <?= $fornecedor['cnpj'] ?>
                </td>
                <td class="td_email align-middle white-space-nowrap">
                  <?= $fornecedor['email'] ?>
                </td>
                <td class="align-middle white-space-nowrap text-center pe-0">
                  <div class="font-sans-serif btn-reveal-trigger position-static">
                    ...
                    <div class="dropdown-menu dropdown-menu-end py-2">
                      <a href="<?= base_url('fornecedores/formulario/' . $fornecedor['id']) ?>" class="dropdown-item editar-lancamento">
                        <span class="fas fa-pencil"></span> Editar
                      </a>
                      <a class="dropdown-item editar-lancamento" href="#" onclick="deletaFornecedor(<?= $fornecedor['id'] ?>)">
